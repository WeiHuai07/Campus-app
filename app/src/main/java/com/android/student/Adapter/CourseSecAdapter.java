...
import com.android.student.Entity.CourseSec;
import java.util.List;
import com.android.student.R;

/**
 *已选课程类的适配器，将课程信息展示在CourseSecFragment上
 *管理员查看所有课程信息
 */
public class CourseSecAdapter extends RecyclerView.Adapter<CourseSecAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.CourseSecName.setText("课程号： "+CourseSec.getCourse_id()+"         "+CourseSec.getCourse_name()+"\n学分："+CourseSec.getCredit()+"\n成绩："+CourseSec.getGrade());
    }
